...
for i in range(D):
    ...
    print('Estimated lengthscale: {:0.3f}'.format(posterior_wishart_process.kernel.kernels[i].lengthscales.numpy().item()))
    print('True variance: {:0.3f}'.format(true_variance[i]))
    print('Estimated variance: {:0.3f}'.format(posterior_wishart_process.kernel.kernels[i].variance.numpy().item()))